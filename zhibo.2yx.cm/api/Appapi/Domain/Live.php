...
class Domain_Live {
	...
	public function setAuction($uid,$auctionid) { 
        $rs = array();
        $model = new Model_Live();
        $rs = $model->setAuction($uid,$auctionid);
	...
	public function setBond($uid,$auctionid) { 
        $rs = array();
        $model = new Model_Live();
        $rs = $model->setBond($uid,$auctionid);
	...
	public function auctionEnd($uid,$auctionid) { 
        $rs = array();
        $model = new Model_Live();
        $rs = $model->auctionEnd($uid,$auctionid);
	...
	public function setBidPrice($uid,$auctionid) { 
        $rs = array();
        $model = new Model_Live();
        $rs = $model->setBidPrice($uid,$auctionid);
