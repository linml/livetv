...
class HomebaseController extends AppframeController {
	...
	function _initialize() {
		...
		$configMsg=M("config")->where("id=1")->field("mobile,address,apk_ewm,ipa_ewm,wechat_ewm,sina_icon,sina_title,sina_desc,sina_url,qq_icon,qq_title,qq_desc,qq_url")->find();
		$configMsg['sina_icon']=get_upload_path($configMsg['sina_icon']);
		$configMsg['qq_icon']=get_upload_path($configMsg['qq_icon']);
		$configMsg['apk_ewm']=get_upload_path($configMsg['apk_ewm']);
		$configMsg['ipa_ewm']=get_upload_path($configMsg['ipa_ewm']);
		$configMsg['wechat_ewm']=get_upload_path($configMsg['wechat_ewm']);
		$this->assign($configMsg);
