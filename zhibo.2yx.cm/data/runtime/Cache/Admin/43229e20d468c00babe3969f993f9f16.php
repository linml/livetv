			...
			<div class="js-tabs-content">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">				
								<input type="text" name="post[cache_time]" value="<?php echo ($config['cache_time']); ?>">秒  网站数据的缓存时间
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">竞拍控制</label>
							<div class="controls">				
								<label class="radio inline"><input type="radio" value="0" name="post[auction_switch]" <?php if(($config['auction_switch']) == "0"): ?>checked="checked"<?php endif; ?>>关闭</label>
								<label class="radio inline"><input type="radio" value="1" name="post[auction_switch]" <?php if(($config['auction_switch']) == "1"): ?>checked="checked"<?php endif; ?>>开启</label>
								<label class="checkbox inline">竞拍是否开启</label>
							</div>
						</div>
						<div class="control-group">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							<label class="control-label">声网ID</label>
							<div class="controls">				
								<input type="text" name="post[agorakitid]" value="<?php echo ($config['agorakitid']); ?>"> 声网应用ID（连麦）
							</div>
						</div>
						<div class="control-group">
				...
				<div>
					<fieldset>
						...
						<div class="control-group">
							...
							<div class="controls">				
									<textarea name="post[aliapp_key_android]"><?php echo ($config['aliapp_key_android']); ?></textarea>支付宝安卓密钥  （对应为 开放平台=》mapi网关产品=》RSA(SHA1)密钥）
							</div>
						</div>
						<div class="control-group">
