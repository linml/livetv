...
<div class="content">
    <div class="div-img">
        <div class="qr-code">
            <div class="qr-img"><img src="<?php echo ($qr_ewm); ?>" style="width:90%;height:auto;margin-left:5%;margin-top:5%;" ></div>
            <div class="qr-right">
        ...
        <div class="bottom">
            ...
            <div class="ab-content">商务合作: 3002541659</div>

            <a class="ab-live" href="/index.php?m=App&a=index">
...
<div class="footer">
		...
		<div class="down-ft">
			<div class="down-ft_one fl">
				...
				<div class="guan_wei">
					<?php if($sina_url != ''): ?><a href="<?php echo ($sina_url); ?>" target="_blank"><?php endif; ?>
						<div class="guan_wei_icon fl">
							<img src="<?php echo ($sina_icon); ?>">
						</div>
						<div class="guan_wei_con fl">
							<p class="guan_wei_title"><?php echo ($sina_title); ?></p>
							<p class="guan_wei_desc"><?php echo ($sina_desc); ?></p>
						</div>
				...
				<div class="guan_wei mar_top15">
					<?php if($qq_url != ''): ?><a href="<?php echo ($qq_url); ?>" target="_blank"><?php endif; ?>
						<div class="guan_wei_icon fl">
							<img src="<?php echo ($qq_icon); ?>">
						</div>
						<div class="guan_wei_con fl">
							<p class="guan_wei_title"><?php echo ($qq_title); ?></p>
							<p class="guan_wei_desc"><?php echo ($qq_desc); ?></p>
						</div>
					<?php if($sina_url != ''): ?></a><?php endif; ?>
					<div class="clearboth"></div>
				</div>
			...
			<div class="down-ft_two fl">
				<ul class="ewm_list">
					<li>
						...
						<p class="ewm_icon"><img src="<?php echo ($wechat_ewm); ?>"></p>
					</li>
					<li>
						<p class="ewm_title">android版下载</p>
						<p class="ewm_icon"><img src="<?php echo ($apk_ewm); ?>"></p>
					</li>
					<li>
						<p class="ewm_title">iPhone版下载</p>
						<p class="ewm_icon"><img src="<?php echo ($ipa_ewm); ?>"></p>
					</li>
					<div class="clearboth"></div>
				</ul>
			</div>
