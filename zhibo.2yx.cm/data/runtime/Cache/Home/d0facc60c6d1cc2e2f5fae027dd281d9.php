...
<!-- 						<li class="had-dialog" id="LF-toggle-square">
			...
			<div class="SR-stager clearfix" id="LF-stager">
				...
				<div class="SR-area-video" id="LF-area-video">
					...
					<div class="MR-about">
						...
						<?php else: ?>
							<?php if($identity == 60): ?><p class="closeroom_icon" data-type="0" id="admin_close">关闭直播</p>	
								<p class="forbidroom_icon" data-type="1" id="admin_stopit">禁止直播</p><?php endif; ?>
							<?php if($identity != 50 and $identity > 10): ?><p class="report_icon" id="admin_report">举报</p><?php endif; endif; ?>
				...
				<!-- <div class="SR-area-info" id="LF-area-info">
					<div class="info-count" id="LF-info-count">
							<div class="MR-count">
								...
								<?php else: ?>
								<?php if($identity == 60): ?><div class="gift">
								...
								<?php if($identity != 50 and $identity > 10): ?><div class="online">
		...
		<script src="/public/home/js/artTemplate.js"></script>
		...
		<?php if($isplay): ?><script type="text/javascript">
			...
			(function(){
						...
						var  script_text= "swfobject.embedSWF(\"/public/home/js/5ShowCamLivePlayer.swf?uid="+_DATA.anchor.id+"&token=<?php echo ($token); ?>&roomId=<?php echo ($push['stream']); ?>&stream="+_DATA.anchor.stream+"&cdn=<?php echo ($push['cdn']); ?>&keyframe=<?php echo ($config['keyframe']); ?>&fps=<?php echo ($config['fps']); ?>&bandwidth=0&width=<?php echo ($config['live_width']); ?>&height=<?php echo ($config['live_height']); ?>&quality=<?php echo ($config['quality']); ?>\" ,\"webplayer\",\"100%\",\"100%\",\"10.0\", \"\",{},{quality:\"high\",wmode:\"opaque\",allowscriptaccess:\"always\"})";
